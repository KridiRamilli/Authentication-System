...
describe("Unit", () => {
  test("Email Validation", () => {
    ...
    expect(isEmailValid("kridiramilli@gmailcom")).toBe(
      "Invalid email format, please enter a valid email!"
    );
    expect(isEmailValid("kridiramilli@gmailco.m")).toBe(
      "Invalid email format, please enter a valid email!"
    );
  ...
  test("Password Validation", () => {
    ...
    expect(isPasswordValid("kr4K")).toBe(
      "Your password must be at least 6 characters long"
    );
    expect(isPasswordValid("Password")).toBe(
      "Your password must contain at least a Number"
    );
    expect(isPasswordValid("password123")).toBe(
  ...
  test("Username Validation", () => {
    ...
    expect(isUsernameValid("kri")).toBe(
      "Username must be at least 5 characters long"
    );
    expect(isUsernameValid("Kridi123")).toBe(
  ...
  test("isConfirmPassword", () => {
    ...
    expect(isConfirmPasswordValid("Kridi123", "kridi123")).toBe(
